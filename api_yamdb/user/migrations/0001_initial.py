    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('first_name', models.CharField(blank=True, default='Пусто', help_text='Заполните Имя', max_length=150, null=True, verbose_name='Имя')),
                ('last_name', models.CharField(blank=True, default='Пусто', help_text='Заполните Фамилию', max_length=150, null=True, verbose_name='Фамилия')),
                ...
                ('bio', models.TextField(blank=True, default='Пусто', help_text='Заполните информацию о себе', null=True, verbose_name='Биография')),
